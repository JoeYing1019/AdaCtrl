...
if __name__ == '__main__':
    ...
    dataset = datasets.load_dataset(path='/mnt/bn/hl-joe/dataset/MATH-500/', data_files=['test.jsonl'])
    ...
    train_dataset.to_parquet(os.path.join(local_dir, 'math500_baseline.parquet'))
