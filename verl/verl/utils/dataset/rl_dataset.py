...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.force_token == "E":
            prompt_with_chat_template = prompt_with_chat_template + "[Easy]"
        elif self.force_token == "H":
            prompt_with_chat_template = prompt_with_chat_template + "[Hard]"
